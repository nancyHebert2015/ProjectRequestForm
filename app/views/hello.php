...
<head>
	...
	<title>Project Request Application</title>
...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top ">
      <div class="navbar-inner row">
          ...
          <a class="brand col-xs-12 col-sm-12 col-md-6 col-lg-6" href="#">Faculty of Medicine</a>
          
          <ul class="nav nav-pills pull-right col-xs-12 col-sm-12 col-md-4 col-lg-4">
    <li class="active"><a href="#"><span class="glyphicon glyphicon-home"></span>  Home</a></li>
    <li><a href="#"><span class="glyphicon glyphicon-user"></span> About</a></li>
    <li><a href="#"><span class="glyphicon glyphicon-envelope"></span> Contact</a></li>
    </ul>

            <!--<form class="navbar-form pull-right col-xs-12 col-sm-12 col-md-3 col-lg-3">
    ...
    <div class="container">
      ...
      <h1>Project Request Form</h1>
        <h2>Brief description of what this is about</h2>
       </header> 
      ...
      <hr>-->
       ...
       <a href="http://www.med.uottawa.ca/eng/index.html" role="link" target="_blank" rel="external">  
        <img src="https://curriculum.med.uottawa.ca/cbl-components/assets/img/FacMedHorWhite_300.png" border="0" width="auto" height="auto" alt="Link to the Faculty of Medicine website">
       </a>
      </section>
